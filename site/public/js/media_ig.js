    ...
    const cargarUrls = async urls => {
        ...
        let item;
            ...
            <section class="post-column">
                ...
                `;
        $('galery').innerHTML = await item
        let item2 = `
        <div class="glider-track" style="overflow-x: auto;">
                <div class="chiquito glider-slide" style="background-image: url('${urls[0].media_url}');"></div>
                <div class="chiquito glider-slide" style="background-image: url('${urls[1].media_url}');"></div>
                <div class="chiquito glider-slide" style="background-image: url('${urls[2].media_url}');"></div>
                <div class="chiquito glider-slide" style="background-image: url('${urls[3].media_url}');"></div>
                <div class="chiquito glider-slide" style="background-image: url('${urls[4].media_url}');"></div>
                <div class="chiquito glider-slide" style="background-image: url('${urls[5].media_url}');"></div>
                <div class="chiquito glider-slide" style="background-image: url('${urls[6].media_url}');"></div>
                <div class="chiquito glider-slide" style="background-image: url('${urls[7].media_url}');"></div>
                <div class="chiquito glider-slide" style="background-image: url('${urls[8].media_url}');"></div>
            </div>`;
        $('g-ig').innerHTML = await item2
